...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['fecha_hora'], $_POST['descripcion'], $_POST['total'])) {
    $fecha_hora = $_POST['fecha_hora'];
    $descripcion = $_POST['descripcion'];
    $total = $_POST['total'];

    // Insert into the egresos table
    $sql = "INSERT INTO egresos (fecha_hora, descripcion, total) VALUES ('$fecha_hora', '$descripcion', '$total')";
